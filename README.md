...
- Location: Chicago, IL
- Email: [jesse@jesseblack.net](mailto:jesse@jesseblack.net)
- Website: [jesseblack.net](https://jesseblack.net/)
...
**Cloud & Eventing:** Azure, Terraform, OpenTofu, Docker, Podman, Event Hub (Kafka-compatible), Service Bus, OpenTelemetry, Azure Monitor Application Insights
...
**Backend:** Distributed systems, REST APIs, C#/.NET, Node.js, Python, SQL Server, Redis
...
- Built agent harnesses for an agentic engineering workflow, combining custom agent tools, hardened dev sandboxes, and automated quality-gate feedback loops.
...
Open-source Rust CLI for repository knowledge systems in agentic engineering repos and GitHub Actions CI.
...
Open-source Rust CLI for Git diff coverage gates in GitHub Actions CI and coding-agent workflows.
...
[PDF version](Jesse_Black_Resume.pdf). Learn more about how and why this resume is built in [ABOUT.md](ABOUT.md)
